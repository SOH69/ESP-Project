        ...
        for i in range(num_segments):
            ...
            for j in range(num_parts):
                ...
                while current_frame < end_part_frame:
                    ...
                    elif amplitude > min_amplitude:
                        min_amplitude = amplitude

                    peakToPeak = max_amplitude - min_amplitude
                    famplitude = peakToPeak - 70
                    print(amplitude, max_amplitude, min_amplitude, famplitude)
                ...
                max_amplitudes.append(famplitude)
